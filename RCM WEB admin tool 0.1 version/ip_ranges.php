...
$queryZ = $db3->query("SELECT * FROM `x_ranges` ORDER BY (id+0) DESC LIMIT 100");
...
echo "<td width='80px'>&emsp;<a href=del1.php?delgg=".$id."><font color='red' size='2'>X</font></a><font color='yellow' size='2'>&emsp;#".substr($id, 0, 7)."</font></td>";
echo "
<td width='110px'><font color='lime' size='2'>&emsp;<b>".$cip.''."</b>&emsp;</font></td>
