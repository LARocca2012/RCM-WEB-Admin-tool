...
//$db3i->query("DELETE FROM bans WHERE id='$deletee'");
 //
//
 $queryZn = $db3i->query("SELECT * FROM bans WHERE id='$deletee' LIMIT 1");
...
$db3i->Query("DELETE FROM bans WHERE ip='$country_name'");
 $datetime = date('Y.m.d H:i:s');
AddToLog('['.$datetime.'] UNBAN: ' . $country_name . ' (' . $pjhv . ') by ('.$kll.') ('.$hhh.')'); 
echo '
<br/><center><H1>'.$pjhv.' UnBaned!</H1>
<H2><a title="Settings" href="banlist.php">return BACK!</a></H2></center>'; 
}
