...
function ciity($string) {
$string = str_replace("UZ", "Uzbekistan", $string);
$string = str_replace("TH", "Thailand", $string);
$string = str_replace("RU", "Russia", $string);
$string = str_replace("LV", "Latvia", $string);
$string = str_replace("LT", "Lithuania", $string);
$string = str_replace("PL", "Poland", $string);
$string = str_replace("AB", "Abkhazia", $string);
$string = str_replace("AU", "Australia", $string);
$string = str_replace("AT", "Austria", $string);
$string = str_replace("AZ", "Azerbaijan", $string);
$string = str_replace("AL", "Albania", $string);
$string = str_replace("DZ", "Algeria", $string);
$string = str_replace("AS", "American Samoa", $string);
$string = str_replace("AI", "Anguilla", $string);
$string = str_replace("AO", "Angola", $string);
$string = str_replace("AD", "Andorra", $string);
$string = str_replace("AR", "Argentina", $string);
$string = str_replace("AM", "Armenia", $string);
$string = str_replace("AW", "Aruba", $string);
$string = str_replace("AF", "Afghanistan", $string);
$string = str_replace("BS", "Bahamas", $string);
$string = str_replace("BY", "Belarus", $string);
$string = str_replace("BZ", "Belize", $string);
$string = str_replace("BE", "Belgium", $string);
$string = str_replace("BM", "Bermuda", $string);
$string = str_replace("BG", "Bulgaria", $string);
$string = str_replace("BO", "Bolivia", $string);
$string = str_replace("BA", "Bosnia and Herzegovina", $string);
$string = str_replace("BW", "Botswana", $string);
$string = str_replace("BR", "Brazil", $string);
$string = str_replace("IO", "British Indian Ocean Territory", $string);
$string = str_replace("HU", "Hungary", $string);
$string = str_replace("VG", "Virgin Islands, British", $string);
$string = str_replace("VI", "Virgin Islands, U.S.", $string);
$string = str_replace("VN", "Vietnam", $string);
$string = str_replace("GA", "Gabon", $string);
$string = str_replace("GE", "Germany", $string);
$string = str_replace("HN", "Honduras", $string);
$string = str_replace("GL", "Greenland", $string);
$string = str_replace("GR", "Greece", $string);
$string = str_replace("GE", "Georgia", $string);
$string = str_replace("DK", "Denmark", $string);
$string = str_replace("EG", "Egypt", $string);
$string = str_replace("IL", "Israel", $string);
$string = str_replace("IN", "India", $string);
$string = str_replace("ID", "Indonesia", $string);
$string = str_replace("IQ", "Iraq", $string);
$string = str_replace("IE", "Ireland", $string);
$string = str_replace("ES", "Spain", $string);
$string = str_replace("IT", "Italy", $string);
$string = str_replace("KZ", "Kazakhstan", $string);
$string = str_replace("KG", "Kyrgyzstan", $string);
$string = str_replace("CN", "China", $string);
$string = str_replace("CO", "Colombia", $string);
$string = str_replace("KR", "Korea, Republic of", $string);
$string = str_replace("NL", "Netherlands", $string);
$string = str_replace("MX", "Mexico", $string);
$string = str_replace("MD", "Moldova", $string);
$string = str_replace("AE", "United Arab Emirates", $string);
$string = str_replace("NO", "Norway", $string);
$string = str_replace("PK", "Pakistan", $string);
$string = str_replace("PT", "Portugal", $string);
$string = str_replace("RO", "Romania", $string);
$string = str_replace("RS", "Serbia", $string);
$string = str_replace("SK", "Slovakia", $string);
$string = str_replace("SL", "Slovenia", $string);
$string = str_replace("GB", "United Kingdom", $string);
$string = str_replace("JM", "Jamaica", $string);
$string = str_replace("EE", "Estonia", $string);
$string = str_replace("ZA", "South Africa", $string);
$string = str_replace("EC", "Ecuador", $string);
$string = str_replace("LK", "Sri Lanka", $string);
$string = str_replace("SE", "Sweden", $string);
$string = str_replace("CH", "Switzerland", $string);
$string = str_replace("CL", "Chile", $string);
$string = str_replace("CZ", "Czech Republic", $string);
$string = str_replace("FR", "France", $string);
$string = str_replace("HR", "Croatia", $string);
$string = str_replace("FI", "Finland", $string);
$string = str_replace("FH", "Philippines", $string);
$string = str_replace("UA", "Ukraine", $string);
$string = str_replace("TR", "Turkey", $string);
$string = str_replace("TT", "Trinidad and Tobago", $string);
$string = str_replace("US", "United States", $string);
$string = str_replace("DE", "Germany", $string);
$string = str_replace("CA", "Canada", $string);
$string = str_replace("MA", "Morocco", $string);
return $string;
}
